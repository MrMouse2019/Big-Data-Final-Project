...
json_path = 'task1_large/' + dataset_name + '.json'
...
for col in columns:
	...
	if len(df):
		...
		with open('task1_xlarge/{}_temp.json'.format(dataset_name), 'a') as outfile:
...
with open('task1_xlarge/{}.json'.format(dataset_name), 'w') as outfile:
