...
json_path = 'task1_mid/' + dataset_name + '.json'
...
for col in columns:
	...
	if len(df):
		...
		with open('task1_mid/{}_temp.json'.format(dataset_name), 'a') as outfile:
...
with open('task1_mid/{}.json'.format(dataset_name), 'w') as outfile:
