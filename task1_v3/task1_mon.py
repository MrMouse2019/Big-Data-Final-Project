...
json_path = 'task1_v3/' + dataset_name + '.json'
...
try:
	print (columns, time.ctime())
except:
	print ('Col names encoding err.')
	print (time.ctime())
...
for col in columns:
	...
	if len(df):
		...
		with open('task1_v3/{}_temp.json'.format(dataset_name), 'a') as outfile:
...
with open('task1_v3/{}.json'.format(dataset_name), 'w') as outfile:
